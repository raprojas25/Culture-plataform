...
const AdminPanel = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div
        className={`min-h-screen w-full transition-all duration-500 -z-50 ${isDarkMode ? "dark" : ""}`}
      >
          ...
          <div className="container mx-auto px-4 py-16">
            <header className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Un diseño moderno con degradados sutiles y soporte completo para
                modo oscuro. Perfecto para landing pages y aplicaciones web.
              </p>
            </header>
              ...
              {[1, 2, 3].map((item) => (
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Este componente incluye degradados dinámicos que se adaptan
                    automáticamente al modo oscuro.
                  </p>
                </div>
              ))}
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20 rounded-2xl p-8 md:p-12 text-center">
              ...
              <p className="text-lg mb-6 text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
                Los colores y opacidades cambian automáticamente según el modo
                de visualización. Prueba a alternar entre modo oscuro y claro
                usando el botón en la esquina inferior derecha.
              </p>
