...
const Contact = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      icon: <Mail className="text-red-500 dark:text-red-400" size={24} />,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
              ...
              {activeTab === "form" ? (
                  ...
                  <AnimatePresence>
                    {isSubmitted && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -10 }}
                        className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl dark:bg-green-900/20 dark:border-green-800"
                      >
                        <div className="flex items-center">
                          <CheckCircle className="text-green-500 dark:text-green-400 mr-3" />
                          <div>
                            <h3 className="font-bold text-green-800 dark:text-green-300">
                              ¡Gracias por contactarnos!
                            </h3>
                            <p className="text-green-600 text-sm dark:text-green-400">
                              Hemos recibido tu mensaje y te responderemos en un
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent focus:outline-none bg-white dark:bg-gray-800 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent focus:outline-none bg-white dark:bg-gray-800 dark:border-gray-600 dark:text-white"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={6}
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent resize-none focus:outline-none bg-white dark:bg-gray-800 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"
                    ...
                    <div className="flex items-start">
                      ...
                      <label htmlFor="terms" className="text-sm text-gray-600 dark:text-gray-300">
                        ...
                        <Link
                          to="/terminos"
                          className="text-red-600 hover:underline dark:text-red-400 ml-1"
                        >
                          {" "}
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full py-4 bg-red-600 text-white font-bold rounded-lg hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-colors"
                    >
                      {isSubmitting ? (
                        <>
                ...
                >
                  <p className="text-gray-600 dark:text-gray-300">
                    Contáctanos directamente a través de cualquiera de estos
                    canales:
                  </p>
                  ...
                  {contactMethods.map((method) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <div className="p-3 rounded-lg bg-white dark:bg-gray-800 mr-4">
                            {method.icon}
                          </div>
                          <div>
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              <div className="bg-gradient-to-br from-red-600 to-orange-500 rounded-2xl p-8 text-white">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <button className="w-full bg-white text-red-600 font-bold py-3 px-6 rounded-lg hover:bg-gray-100 flex items-center justify-center gap-2 transition-colors">
            ...
            <motion.div
              variants={fadeInUp}
              className="bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-2xl p-6 dark:from-blue-900/20 dark:to-cyan-900/20 dark:border-blue-800"
            >
            ...
            <motion.div
              variants={fadeInUp}
              className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-colors"
            >
              <h2 className="text-2xl font-bold mb-6 flex items-center text-gray-900 dark:text-white">
                <Clock className="mr-3 text-red-600 dark:text-red-400" />
                Horarios de Atención
              </h2>
            ...
            >
                ...
                {[
                  {
                    ...
                    answer:
                      'Ve a "Publicar Evento" y sigue los pasos del formulario.',
                  },
                  {
              ...
              <Link
                to="/faq"
                className="inline-flex items-center mt-6 text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 font-medium transition-colors"
              >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition-colors">
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              <h2 className="text-2xl font-bold flex items-center text-gray-900 dark:text-white">
                <MapPin className="mr-3 text-red-600 dark:text-red-400" />
                Ubicación de Nuestra Oficina
              </h2>
            </div>

            <div className="h-96 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 relative transition-colors">
              {/* Mapa placeholder */}
              ...
              <div className="absolute top-1/2 left-1/3 transform -translate-x-1/2 -translate-y-1/2">
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-3 transition-colors">
                  <div className="flex items-center">
        ...
        >
          <p className="text-sm text-gray-500 dark:text-gray-400 max-w-3xl mx-auto">
            ...
            . Nos comprometemos a proteger tus datos personales y a no
            compartirlos con terceros sin tu consentimiento. Todos los mensajes
            son respondidos por nuestro equipo en un plazo máximo de 48 horas
            hábiles.
          </p>
        </motion.div>
      </div>
