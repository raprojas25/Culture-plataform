              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-lg">
                    ¿Quieres que sea "Evento Destacado"?
                  </h3>
                  <p className="text-yellow-700">
                    Tu evento aparecerá en la página principal
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <label htmlFor="terms" className="text-sm text-gray-600">
                Acepto los{" "}
                <Link to="/terminos" className="text-red-600 hover:underline">
                  {}Términos y Condiciones
                </Link>{" "}
                y autorizo la publicación de este evento.
              </label>
            </div>
            ...
            <p className="text-center text-sm text-gray-500">
              * Tu evento será revisado antes de ser publicado. Te notificaremos
              cuando sea aprobado.
            </p>
          </div>
        </form>
