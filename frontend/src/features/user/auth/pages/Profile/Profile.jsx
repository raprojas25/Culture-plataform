...
export const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:bg-gray-800">
      ...
      <div className="container mx-auto px-4 -mt-16 dark:bg-gray-800  pb-8">
        {/* Sección de perfil */}
        <motion.div
          initial="hidden"
          animate="visible"
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="flex items-center">
                    ...
                    <span className={isEditing ? "hidden" : ""}>
                      {userData.email}
                    </span>
                    {isEditing && (
                      <input
          ...
          <div className="border-t border-gray-200">
            <div className="flex overflow-x-auto">
              {tabs.map((tab) => (
                ...
                >
                  {tab.icon}
                  <span className="ml-2 text-nowrap">{tab.label}</span>
            ...
            >
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                  ...
                  <div className="space-y-4">
                    {[
                      {
                        action: 'Creaste el evento "Fiesta Patronal"',
                        time: "Hace 2 días",
                      },
                      {
                        action: "Recibiste 45 nuevos asistentes",
                        time: "Hace 3 días",
                      },
                      {
                        action: "Actualizaste tu información de perfil",
                        time: "Hace 1 semana",
                      },
                      {
                        action: "Agregaste 3 eventos a favoritos",
                        time: "Hace 2 semanas",
                      },
                    ].map((activity, index) => (
                      <div
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    {
                      title: "Organizador Activo",
                      desc: "Más de 10 eventos",
                      icon: "🏆",
                    },
                    { title: "Comunidad", desc: "500+ asistentes", icon: "👥" },
                    {
                      title: "Calidad",
                      desc: "4.8 rating promedio",
                      icon: "⭐",
                    },
                    {
                      title: "Consistencia",
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    <div>
                      ...
                      <p className="text-gray-600">
                        Gestiona todos tus eventos publicados
                      </p>
                    </div>
                ...
                <div className="p-6 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="text-gray-600">
                      Mostrando {userEvents.length} de {userEvents.length}{" "}
                      eventos
                    </div>
                ...
                {favoriteEvents.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 mb-6">
                      Comienza guardando eventos que te interesen
                    </p>
                    <button
                      onClick={() => navigate("/")}
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          {[
                            ...
                            {
                              label: "Mostrar email",
                              desc: "Visible para otros usuarios",
                              checked: false,
                            },
                            {
                              label: "Mostrar teléfono",
                              desc: "Visible para organizadores",
                              checked: true,
                            },
                            {
                              label: "Mostrar ubicación",
                              desc: "Visible en tu perfil",
                              checked: true,
                            },
                          ].map((setting, index) => (
                            <div
                          ...
                          <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg">
                            <div>
                              ...
                              <p className="text-sm text-red-600">
                                Elimina permanentemente tu cuenta y todos tus
                                datos
                              </p>
                            </div>
                            <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono">
                          USR-{userData.id.toString().padStart(6, "0")}
                        </span>
                      </div>
                      <div className="flex justify-between">
