...
export const roleService = {
  ...
  getAvailablePermissions: async () => {
    ...
    return [
      ...
      {
        code: "events:write",
        name: "Escribir eventos",
        description: "Permite crear, editar y eliminar eventos",
      },
      {
        code: "events:moderate",
        name: "Moderar eventos",
        description: "Permite aprobar/rechazar eventos",
      },
      {
      ...
      },
      {
        ...
        name: "Escribir categorías",
        description: "Permite crear, editar y eliminar categorías",
      },
      {
        code: "districts:read",
        name: "Leer distritos",
        description: "Permite ver distritos",
      },
      {
        code: "districts:write",
        name: "Escribir distritos",
        description: "Permite crear, editar y eliminar distritos",
      },
      {
        code: "roles:read",
        name: "Leer roles",
